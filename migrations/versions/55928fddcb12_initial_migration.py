...
def upgrade():
    ...
    sa.Column('semester', sa.Enum('SPRING', 'FALL', 'SUMMER', name='semesterenum'), nullable=True),
    sa.Column('year', sa.Integer(), nullable=True),
    sa.Column('application_due', sa.Date(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=False),
    sa.Column('last_updated', sa.DateTime(), nullable=True),
    sa.Column('location', sa.Enum('TBD', 'AMOS_EATON', 'CARNEGIE', 'CBIS', 'CCI', 'CII', 'COGSWELL', 'DCC', 'EMPAC', 'GREENE', 'JEC', 'JROWL', 'LALLY', 'LINAC', 'MRC', 'PITTSBURGH', 'RICKETTS', 'SAGE', 'VCC', 'WALKER', 'WEST', 'WINSLOW', 'REMOTE', name='locationenum'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('rpi_schools',
    sa.Column('name', sa.String(length=64), nullable=False),
    sa.Column('description', sa.String(length=2000), nullable=True),
    sa.PrimaryKeyConstraint('name')
    )
    op.create_table('recommends_class_years',
    sa.Column('opportunity_id', sa.Integer(), nullable=False),
    sa.Column('class_year', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['class_year'], ['class_years.class_year'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['opportunity_id'], ['opportunities.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('opportunity_id', 'class_year')
    )
    op.create_table('recommends_courses',
    sa.Column('opportunity_id', sa.Integer(), nullable=False),
    ...
    op.create_table('rpi_departments',
    sa.Column('name', sa.String(length=64), nullable=False),
    sa.Column('description', sa.String(length=2000), nullable=True),
    sa.Column('school_id', sa.String(length=64), nullable=True),
    sa.ForeignKeyConstraint(['school_id'], ['rpi_schools.name'], ),
    sa.PrimaryKeyConstraint('name')
    )
    op.create_table('lab_manager',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('department_id', sa.String(length=64), nullable=True),
    sa.ForeignKeyConstraint(['department_id'], ['rpi_departments.name'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('leads',
    sa.Column('lab_manager_id', sa.Integer(), nullable=False),
    sa.Column('opportunity_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['lab_manager_id'], ['lab_manager.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['opportunity_id'], ['opportunities.id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['class_year'], ['class_years.class_year'], ),
    sa.ForeignKeyConstraint(['lab_manager_id'], ['lab_manager.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email'),
    sa.UniqueConstraint('id')
    )
    op.create_table('management_permissions',
    ...
    sa.Column('user_id', sa.String(length=9), nullable=False),
    sa.Column('major_code', sa.String(length=4), nullable=False),
    sa.ForeignKeyConstraint(['major_code'], ['majors.code'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'major_code')
    )
    op.create_table('user_saved_opportunities',
    sa.Column('user_id', sa.String(length=9), nullable=False),
    sa.Column('opportunity_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['opportunity_id'], ['opportunities.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
